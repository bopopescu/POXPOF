...
process 6 types of POF message:
    FEATURES_REPLY
    PORT_STATUS
    RESOURCE_REPORT
    COUNTER_REPLY
...
from pox.openflow import CounterReply
...
def handle_COUNTER_REPLY (con, msg):
    ...
    e = con.ofnexus.raiseEventNoErrors(CounterReply, con, msg)
    if e is None or e.halt != True:
        con.raiseEventNoErrors(CounterReply, con, msg)
