...
#import libpof_01 as of
import libpof_02 as of
#import libpof_01_tianye as of
from pox.lib.packet.ethernet import ethernet

class GetConfigReply(Event):
    """
...
class OpenFlowConnectionArbiter (EventMixin):
    ...
    def getNexus (self, connection):
        ...
        self.raiseEventNoErrors(e)     # raise Event 'ConnectionIn'
        if e.nexus is None:
        ...
        if e.nexus is False:
            ...
            #print ('class OpenFlowConnectionArbiter --> e.nexus:',e.nexus)   #cc
        return e.nexus
